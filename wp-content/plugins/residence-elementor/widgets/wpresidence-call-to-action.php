...
class Wpresidence_Call_To_Action extends Widget_Base {

	public function get_name() {
		return 'wpresidence-call-to-action';
	}
	...
	public function get_title() {
		return esc_html__( 'Wpresidence Call to Action', 'residence-elementor' );
	}
	...
	public function get_style_depends(): array {
		return [ 'wpresidence-call-to-action-style', 'e-transitions' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'classic' => esc_html__( 'Classic', 'residence-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'below' => [
						'title' => esc_html__( 'Below', 'residence-elementor' ),
		...
		$this->add_control(
			'bg_image',
			[
				'label' => esc_html__( 'Choose Image', 'residence-elementor' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Image Resolution', 'residence-elementor' ),
				'default' => 'large',
				'condition' => [
					'bg_image[id]!' => '',
				],
		...
		$this->add_control(
			'graphic_element',
			[
				'label' => esc_html__( 'Graphic Element', 'residence-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'none' => [
						'title' => esc_html__( 'None', 'residence-elementor' ),
						'icon' => 'eicon-ban',
					],
					'image' => [
						'title' => esc_html__( 'Image', 'residence-elementor' ),
						'icon' => 'eicon-image-bold',
					],
					'icon' => [
						'title' => esc_html__( 'Icon', 'residence-elementor' ),
						'icon' => 'eicon-star',
					],
				],
				'default' => 'none',
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'This is the heading', 'residence-elementor' ),
				'placeholder' => esc_html__( 'Enter your title', 'residence-elementor' ),
				'label_block' => true,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'title_tag',
			[
				'label' => esc_html__( 'Title HTML Tag', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter your description', 'residence-elementor' ),
				'separator' => 'before',
				'rows' => 5,
			]
		);
		...
		$this->add_control(
			'description_tag',
			[
				'label' => esc_html__( 'Description HTML Tag', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			'button',
			[
				'label' => esc_html__( 'Button Text', 'residence-elementor' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => esc_html__( 'Click Here', 'residence-elementor' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'link_click',
			[
				'label' => esc_html__( 'Apply Link On', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'box' => esc_html__( 'Whole Box', 'residence-elementor' ),
					'button' => esc_html__( 'Button Only', 'residence-elementor' ),
				],
				'default' => 'button',
				'condition' => [
					'link[url]!' => '',
		...
		$this->start_controls_section(
			'section_ribbon',
			[
				'label' => esc_html__( 'Ribbon', 'residence-elementor' ),
			]
		);
		...
		$this->start_controls_section(
			'box_style',
			[
				'label' => esc_html__( 'Box', 'residence-elementor' ),
		...
		$this->add_control(
			'vertical_position',
			[
				'label' => esc_html__( 'Vertical Position', 'residence-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
		...
		$this->add_control(
			'icon_view',
			[
				'label' => esc_html__( 'View', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Default', 'residence-elementor' ),
					'stacked' => esc_html__( 'Stacked', 'residence-elementor' ),
					'framed' => esc_html__( 'Framed', 'residence-elementor' ),
				],
				'default' => 'default',
				'condition' => [
					'graphic_element' => 'icon',
		...
		$this->add_control(
			'icon_shape',
			[
				'label' => esc_html__( 'Shape', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => esc_html__( 'Circle', 'residence-elementor' ),
					'square' => esc_html__( 'Square', 'residence-elementor' ),
				],
				'default' => 'circle',
				'condition' => [
					'icon_view!' => 'default',
		...
		$this->add_control(
			'icon_primary_color',
			[
				'label' => esc_html__( 'Primary Color', 'residence-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Secondary Color', 'residence-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'graphic_element' => 'icon',
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => esc_html__( 'Icon Padding', 'residence-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'selectors' => [
		...
		$this->add_control(
			'description_color',
			[
				'label' => esc_html__( 'Description Color', 'residence-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'ribbon_distance',
			[
				'label' => esc_html__( 'Distance', 'residence-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			'hover_effects',
			[
				'label' => esc_html__( 'Hover Effects', 'residence-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'content_animation',
			[
				'label' => esc_html__( 'Hover Animation', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'groups' => [
					[
						'label' => esc_html__( 'None', 'residence-elementor' ),
						'options' => [
							'' => esc_html__( 'None', 'residence-elementor' ),
						],
					],
					[
						'label' => esc_html__( 'Entrance', 'residence-elementor' ),
						'options' => [
					...
					[
						'label' => esc_html__( 'Reaction', 'residence-elementor' ),
						'options' => [
							'grow' => 'Grow',
							'shrink' => 'Shrink',
					...
					[
						'label' => esc_html__( 'Exit', 'residence-elementor' ),
						'options' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration', 'residence-elementor' ) . ' (ms)',
				'type' => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'default' => [
					'size' => 1000,
		...
		$this->add_control(
			'sequenced_animation',
			[
				'label' => esc_html__( 'Sequenced Animation', 'residence-elementor' ),
		...
		$this->add_control(
			'overlay_blend_mode',
			[
				'label' => esc_html__( 'Blend Mode', 'residence-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Normal', 'residence-elementor' ),
					'multiply' => 'Multiply',
					'screen' => 'Screen',
					'overlay' => 'Overlay',
					'darken' => 'Darken',
		...
		$this->add_control(
			'effect_duration',
			[
				'label' => esc_html__( 'Transition Duration', 'residence-elementor' ) . ' (ms)',
				'type' => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'default' => [
					'size' => 1500,
