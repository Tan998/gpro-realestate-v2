...
class Wpresidence_Single_Agency_Whatsapp_Button extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_agency_whatsapp_button';
    }
    ...
    public function get_title() {
        return esc_html__('Single Agency WhatsApp Button', 'residence-elementor');
    }
