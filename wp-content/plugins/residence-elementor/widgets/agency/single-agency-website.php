...
class Wpresidence_Agency_Single_Website extends Widget_Base {
	...
	public function get_title() {
		return __( 'Agency Single Website', 'residence-elementor' );
	}
	...
	public function get_icon() {
		return 'wpresidence-note eicon-url';
	}
