    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
                    '{{WRAPPER}} .wpestate_empty_wrapper' => 'gap: 5px; text-align: {{VALUE}};',
                ],
				// 'separator' => 'after',
			]
		);
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'reviews_text_typography',
                'label'    => esc_html__( 'Text Typography', 'residence-elementor' ),
                'selector' => '{{WRAPPER}} .wpestate_empty_wrapper, {{WRAPPER}} .wpestate-no-reviews',
                'global'   => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .wpestate-no-reviews'    => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'stars_color',
            [
                'label'     => esc_html__( 'Stars Color', 'residence-elementor' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'stars_size',
            [
                'label' => esc_html__( 'Stars Size', 'residence-elementor' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [ 'min' => 8, 'max' => 60 ],
                ],
                'selectors' => [
                    '{{WRAPPER}} .property_ratings i' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
