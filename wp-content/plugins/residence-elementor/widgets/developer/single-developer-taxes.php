...
class Wpresidence_Developer_Single_Taxes extends Widget_Base {
	...
	public function get_title() {
		return __( 'Developer Single Taxes', 'residence-elementor' );
	}
	...
	protected function render() {
        ...
        $attributes['detail']            =   'realtor_taxes';
        $attributes['label']             =   'Taxes:';
