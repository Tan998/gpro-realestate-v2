...
class Wpresidence_Single_Developer_Image extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single Developer Image', 'wpresidence-studio-templates');
    }
