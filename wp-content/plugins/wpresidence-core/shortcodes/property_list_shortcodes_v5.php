...
function wpestate_recent_posts_pictures_new($attributes, $content = null) {
    ...
    $return_string .= sprintf(
        '<div id="%s" class="wpresidence_shortcode_listings_wrapper wpestate_anime wpestate_latest_listings_sh bottom-%s %s" data-type="%s" data-category_ids="%s" data-action_ids="%s" data-city_ids="%s"  data-area_ids="%s" data-state_ids="%s" data-status_ids="%s" data-features_ids="%s" data-number="%s" data-row-number="%s" data-card-version="%s" data-align="%s" data-show_featured_only="%s" data-random_pick="%s" data-featured_first="%s" data-sort-by="%s" 
        data-display-grid="%s" data-agent-id="%s" data-topbar_select_model="%s"   data-page="1">',
        ...
        esc_attr($attributes['topbar_select_model'])
    );
