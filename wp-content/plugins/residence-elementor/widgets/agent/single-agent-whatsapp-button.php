...
class Wpresidence_Single_Agent_Whatsapp_Button extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_agent_whatsapp_button';
    }
    ...
    public function get_title() {
        return esc_html__('Single Agent WhatsApp Button', 'residence-elementor');
    }
