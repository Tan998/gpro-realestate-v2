    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Allow user registration?', 'wprentals-core' ),
                'subtitle' => __( 'Enable or disable user registration.', 'wprentals-core' ),
                'options'  => array(
                    'yes' => 'yes',
                    'no'  => 'no'
                    ),
        ...
        'fields'     => array(
           array(
            ...
            array(
                ...
                'type' => 'text',
                'title' => __('Subject for Approved User', 'wprentals-core'),
                'subtitle' => __('Email subject for Approved User', 'wprentals-core'),
                'default' => __('Your account was approved', 'wprentals-core')
            ),
            array(
                'id' => 'wp_estate_approved_user',
                'type' => 'editor',
                'title' => __('Content for Approved User', 'wprentals-core'),
                'subtitle' => __('Email content for Approved User', 'wprentals-core'),
                'default' => __('Hi there,
                    Your account was approved on  %website_url! You can now log in.', 'wprentals-core'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'See how you can get the reCaptha key ', 'wprentals-core' ).'<a href="https://help.wpresidence.net/article/recaptcha-settings-in-theme-options/" target="_blank">Tutorial</a>',
            ),
            array(
                ...
                'subtitle' => __( 'See how you can get the reCaptha secret key ', 'wprentals-core' ).'<a href="https://help.wpresidence.net/article/recaptcha-settings-in-theme-options/" target="_blank">Tutorial</a>',
            ),
        ),
    ) );
