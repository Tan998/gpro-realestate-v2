...
class Wpresidence_Single_Agent_Image extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single Agent Image', 'residence-elementor');
    }
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wpresidence-post-featured-image' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wpresidence-post-featured-image' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wpresidence-post-featured-image' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wpresidence-post-featured-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
    				...
    				'{{WRAPPER}} .wpresidence-post-featured-image' =>
        				'background-position: center top; background-repeat: no-repeat; background-size: {{VALUE}};',
				],
			]
		);
