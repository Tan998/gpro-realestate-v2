...
class Wpresidence_Single_Agency_Excerpt extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single Agency excerpt', 'wpresidence-studio-templates');
    }
