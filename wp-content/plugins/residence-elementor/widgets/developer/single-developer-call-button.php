...
class Wpresidence_Single_Developer_Call_Button extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_developer_call_button';
    }
    ...
    public function get_title() {
        return esc_html__('Single Developer Call Button', 'residence-elementor');
    }
        ...
        $this->add_control(
           ...
           $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpresidence_button.wpresidence_button_inverse.realtor_call i' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
...
/**
  ...
  protected function render() {
    ...
    if ($post_id) {
        ...
        echo '<a class="wpresidence_button wpresidence_button_inverse realtor_call" href="tel:'. esc_attr($details['realtor_phone']) .'">
        <i class="fas fa-phone"></i>'. esc_html__($settings['label'], 'wpresidence') . ' <span class="agency_call_no">' . esc_html($details['realtor_phone']) . '</span></a>';
    }
