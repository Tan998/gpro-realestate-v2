...
class Wpresidence_Single_Agent_Call_Button extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_agent_call_button';
    }
    ...
    public function get_title() {
        return esc_html__('Single Agent Call Button', 'residence-elementor');
    }
...
/**
  ...
  protected function render() {
    ...
    if ($post_id) {
        ...
        <i class="fas fa-phone"></i>'. esc_html__($settings['label'], 'wpresidence') . ' <span class="agent_call_no">' . esc_html($details['realtor_phone']) . '</span></a>';
    }
