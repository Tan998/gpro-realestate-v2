...
class Wpresidence_Single_Agent_Description extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_agent_description';
    }
    ...
    public function get_title() {
        return esc_html__('Single Agent Description', 'wpresidence-studio-templates');
    }
