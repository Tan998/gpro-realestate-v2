...
class FacebookApp implements \Serializable
{
    ...
    /**
     * Returns an array representation suitable for serialization.
     *
     * @return array
     */
    ...
    /**
     * Restores the app from a serialized array representation.
     *
     * @param array $data
     */
    public function __unserialize(array $data)
    {
        ...
        $secret = array_key_exists('secret', $data) ? $data['secret'] : '';
