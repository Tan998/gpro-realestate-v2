...
class Contact_widget extends WP_Widget {
	...
	function widget($args, $instance){
		...
		if($instance['address_info']){
                    ...
                    $display.='<p class="widget_contact_addr"><i class="fas fa-building"></i>'.$co_address.'</p>';
		}
		...
		if($instance['email']){
                    ...
                    $display.='<p class="widget_contact_email"><i class="far fa-envelope"></i><a href="mailto:'.esc_html( antispambot( $co_email) ).'">'.esc_html(antispambot($co_email)).'</a></p>';
		}
