...
class Wpresidence_Agency_Single_Opening_Hours extends Widget_Base {
	...
	public function get_name() {
		return 'Agency_Single_Opening_Hours';
	}
	...
	public function get_title() {
		return __( 'Agency Single Opening Hours', 'residence-elementor' );
	}
	...
	protected function render() {
        ...
        $attributes['detail']            =   'realtor_opening_hours';
        $attributes['label']             =   'Opening Hours:';
