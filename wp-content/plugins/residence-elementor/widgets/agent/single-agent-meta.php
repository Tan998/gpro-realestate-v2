...
class Wpresidence_Agent_Single_Detail extends Widget_Base {
	...
	public function get_title() {
		return __( 'Agent Single Detail', 'residence-elementor' );
	}
