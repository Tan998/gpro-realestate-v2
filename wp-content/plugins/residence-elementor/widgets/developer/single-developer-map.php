...
class Wpresidence_Developer_Map extends Widget_Base {
	...
	public function get_name() {
		return 'Wpresidence_Developer_Map';
	}
	...
	public function get_title() {
		return __( 'Developer Map', 'residence-elementor' );
	}
	...
	protected function render() {
        ...
        if ($post_id) {
            ...
            echo wpestate_load_agenncy_map_template( $settings );
