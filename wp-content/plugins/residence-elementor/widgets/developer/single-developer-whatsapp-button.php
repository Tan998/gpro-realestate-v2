...
class Wpresidence_Single_Developer_Whatsapp_Button extends Widget_Base {
    ...
    public function get_name() {
        return 'Single_developer_whatsapp_button';
    }
    ...
    public function get_title() {
        return esc_html__('Single Developer WhatsApp Button', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} a.wpresidence_button:hover, {{WRAPPER}} .wpresidence_button:hover' => 'background-color: {{VALUE}};background-image: none;',
                ],
            ]
        );
        ...
        $this->add_control(
         ...
         $this->add_control(
            ...
            [
                'label' => __( 'Icon/Text Gap', 'elementor' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpresidence_button.wpresidence_button_inverse.realtor_whatsapp i' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
...
/**
  ...
  protected function render() {
    ...
    if ($post_id) {
        ...
        $whatsapp_message = wpestate_return_agent_whatsapp_call(-1, $details['realtor_mobile']);
        
        echo '<a class="wpresidence_button wpresidence_button_inverse realtor_whatsapp" target="_blank" href="'. esc_url($whatsapp_message) . '"><i class="fab fa-whatsapp"></i> '. esc_html__($settings['label'], 'wpresidence') . '</a>';
    }
