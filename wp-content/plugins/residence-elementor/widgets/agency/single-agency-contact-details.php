...
class Wpresidence_Agency_Contact_Details extends Widget_Base {
	...
	public function get_name() {
		return 'Wpresidence_Agency_Contact_Details';
	}
	...
	public function get_title() {
		return __( 'Agency Contact Details', 'residence-elementor' );
	}
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'label_text_color', [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .agent_custom_detail_wrapper strong' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector' => '{{WRAPPER}} .agent_custom_detail_wrapper strong',
                'global'   => [
        ...
        $this->add_control(
            'detail_text_color', [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .agent_custom_detail_wrapper a, {{WRAPPER}} .agent_custom_detail_wrapper span' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector' => '{{WRAPPER}} .agent_custom_detail_wrapper a, {{WRAPPER}} .agent_custom_detail_wrapper span',
                'global'   => [
                    'default' => Global_Typography::TYPOGRAPHY_PRIMARY
                ],
            ]
	...
	protected function render() {
        ...
        if ($post_id) {
            ...
            echo wpestate_display_agency_contact_details( $post_id );
        }
	}
