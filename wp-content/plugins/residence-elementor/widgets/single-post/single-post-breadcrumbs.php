...
class Wpresidence_Single_Post_Breadcrumbs extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single Post Breadcrumbs', 'residence-elementor');
    }
    ...
    public function get_icon() {
        return 'wpresidence-note eicon-navigation-horizontal';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
                    'section_content',
                    [
                            'label' => __( 'Breadcrumbs',  'residence-elementor' ),
                    ]
        );
...
/**
  ...
  protected function render() {
    ...
    if ($post_id) {
        ...
        echo wpestate_post_breadcrumbs_html();
    }
